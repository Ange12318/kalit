...
import {
  ...
  QuestionMarkCircleIcon, ValidationIcon, PrintIcon, RegisterIcon,
} from './Icons';

interface RegistreSondagesProps {
  onNavigateBack: () => void;
}

const tableHeaders = [
  "N°DOSSIER", "REFERENCE", "PRODUIT", "VILLE", "EXPORTATEUR", "DATE RECEPTION",
  "RECOLTE", "MAGASIN", "GRADE LOT", "DATE SONDAGE", "POIDS ECHANTILLONS", "SONDEUR", "RAPPORT"
];

const RegistreSondages: React.FC<RegistreSondagesProps> = ({ onNavigateBack }) => {
  return (
    <div className="p-6 lg:p-10 space-y-8 bg-gray-50">
      ...
      <div className="bg-[#0d2d53] text-white rounded-t-xl p-6 flex items-center shadow-lg">
        ...
        <div>
          <h2 className="text-3xl font-bold">Registre des Sondages</h2>
          <p className="text-blue-200">Historique et suivi des opérations de sondage</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-b-xl shadow-lg border">
          ...
          <div className="overflow-x-auto border rounded-lg shadow-md">
            <table className="min-w-full text-xs">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                    <td colSpan={tableHeaders.length + 2} className="text-center py-20">
        ...
        <div className="flex justify-end gap-4 mt-6 pt-6 border-t">
            ...
            <button className="bg-[#0d2d53] hover:bg-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow-md transition-colors">Sonder la Sélection</button>
            <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow-md transition-colors">Exporter le Registre</button>
            <button className="bg-white hover:bg-gray-100 text-gray-700 font-bold py-2 px-6 rounded-lg border border-gray-300 shadow-sm transition-colors">Générer Rapport</button>
...
export default RegistreSondages;
