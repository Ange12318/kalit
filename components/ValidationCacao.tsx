...
const tableHeaders = [
  'REF DEMANDE', 'AUTORISATION', 'EXPORTATEUR', 'N°LOT', 'ANALYSEUR',
  'CAMPAGNE', 'VILLE', 'BRISURE', 'DÉCHET', 'CRABOT', 'MATIÈRE ÉTR...',
  'GRAINA...', 'HUMIDITÉ', 'MOISIE', 'MITÉE', 'ARDOISÉE', 'PLATE', 'GEMMÉE',
  'VIOLETTE', 'DÉFECTUE...', 'NORME IVOIRIENNE', 'NORME INTERNATIONALE',
  'CONFORMITÉ', 'REMARQUE'
];
    ...
    <div className="p-6 lg:p-10 space-y-8">
      ...
      <div className="bg-white p-6 rounded-b-xl shadow-lg border">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2 text-sm font-medium text-white bg-[#0d2d53] rounded-md hover:bg-blue-800">Suivant</button>
                 <button className="px-4 py-2 text-sm font-medium text-white bg-[#0d2d53] rounded-md hover:bg-blue-800">Exporter</button>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-4 mt-6 pt-6 border-t">
            ...
            <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow-md transition-colors flex items-center gap-2"><ExportIcon className="h-5 w-5"/><span>Exporter</span></button>
