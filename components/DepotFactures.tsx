...
const tableHeaders = [
  "Réf. Facture", "Date Facture", "Exportateur", "Montant", "Statut Dépôt", "Date Dépôt"
];

const DepotFactures: React.FC<DepotFacturesProps> = ({ onNavigateBack }) => {
  return (
    <div className="p-6 lg:p-10 space-y-8">
      <div className="bg-[#0d2d53] text-white rounded-t-xl p-6 flex items-center shadow-lg">
        <DownloadIcon className="h-10 w-10 mr-4" />
        <div>
          <h2 className="text-3xl font-bold">Dépôt des Factures</h2>
          <p className="text-blue-200">Suivi du statut de dépôt des factures</p>
        </div>
      </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                    <td colSpan={tableHeaders.length + 1} className="text-center py-20">
                        ...
                        <p className="text-gray-500 font-semibold mt-2">Aucune facture en attente de dépôt</p>
                    </td>
                </tr>
              </tbody>
            </table>
