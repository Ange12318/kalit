...
const tableHeaders = [
  "Code Secret", "Date Analyse", "Produit", "Exportateur", "N° Lot", "Analyseur", "Conformité", "Actions"
];
  ...
  return (
    <div className="p-6 lg:p-10 space-y-8">
      <div className="bg-[#0d2d53] text-white rounded-t-xl p-6 flex items-center shadow-lg">
        ...
        <div>
          <h2 className="text-3xl font-bold">Résultats d'Analyses</h2>
          <p className="text-blue-200">Consultation des résultats d'analyses finalisées</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-b-xl shadow-lg border space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            <div className="space-y-1">
             ...
             <div className="space-y-1">
              ...
              <select className="w-full form-select"><option>Tous</option><option>Cacao</option><option>Café</option></select>
            </div>
            <div className="space-y-1">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                    <td colSpan={tableHeaders.length} className="text-center py-20">
                        ...
                        <p className="text-gray-500 font-semibold mt-2">Aucun résultat à afficher</p>
                    </td>
                </tr>
              </tbody>
            </table>
        ...
        <div className="flex justify-end gap-4 mt-6 pt-6 border-t">
            <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg shadow-md flex items-center gap-2"><ExportIcon className="h-5 w-5"/>Exporter les résultats</button>
