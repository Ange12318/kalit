...
interface ExportBVCafeProps {
  onNavigateBack: () => void;
}

const tableHeaders = [
  'Ref. Demande', 'Exportateur', 'Magasin', 'N°Lots', 'Nbre sacs', 'Campagne', 
  'Recolte', 'Agent de Saisie', 'Grade Déclaré', 'Date analyse', 'Date echantillons', 
  'Analyseur', 'Tamis 18', 'Tamis 16', 'Tamis 14', 'Tamis 12', 'Tamis 10', 
  'Tamis bas', 'Humidité', 'Poids defauts', 'Nbre Defauts', 'Classe ...NI', 
  'Classe .FCC', 'Conforme', 'REF BV BA'
];

const ExportBVCafe: React.FC<ExportBVCafeProps> = ({ onNavigateBack }) => {
  return (
    <div className="p-6 lg:p-10 space-y-8 bg-gray-50">
      ...
      <div className="bg-[#0d2d53] text-white rounded-t-xl p-6 flex items-center shadow-lg">
        ...
        <div>
          <h2 className="text-3xl font-bold">Export BV Café</h2>
          <p className="text-blue-200">Export des Bulletins de Vente pour le café</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-b-xl shadow-lg border">
        ...
        <div className="mb-6 pb-6 border-b">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 text-sm items-end">
            ...
            <div className="space-y-1">
              <label className="font-medium text-gray-600">N° du lot</label>
