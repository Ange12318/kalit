...
const tableHeaders = [
  ...
  "RECOLTE", "MAGASIN", "GRADE LOT", "DATE BRASSAGE", "BRASSEUR"
];

const RegistreBrassages: React.FC<RegistreBrassagesProps> = ({ onNavigateBack }) => {
  return (
    <div className="p-6 lg:p-10 space-y-8 bg-gray-50">
      ...
      <div className="bg-[#0d2d53] text-white rounded-t-xl p-6 flex items-center shadow-lg">
        ...
        <div>
          <h2 className="text-3xl font-bold">Registre des brassages</h2>
          <p className="text-blue-200">Historique et suivi des opérations de brassage</p>
        </div>
      </div>
...
export default RegistreBrassages;